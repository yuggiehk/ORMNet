...
class UnetdecoderSeperateHeadsInputFeatureCrossAttnLayer3(BaseDecodeHead):
    r""" Swin Transformer
    ...
    def forward_up_features(self, x, x_downsample, feature_hand):
    ...
    def forward(self,x, feature_hand):
        ...
        x_downsample = x
        x = x_downsample[3]
        x = self.forward_up_features(x,x_downsample,feature_hand)
